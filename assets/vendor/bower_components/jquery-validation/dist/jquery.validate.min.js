! function(t) {
   ...
   t.extend(t.fn, {
      ...
      messages: {
         ...
         number: numero_valido,
         digits: apenas_numeros,
         equalTo: dados_nao_conferem,
         maxlength: t.validator.format(numero_maximo),
         minlength: t.validator.format(numero_minimo),
      ...
      prototype: {
         ...
         element: function(e) {
            ...
            }), i = this.check(n) !== !1, o = o && i, i ? this.invalid[n.name] = !1 : this.invalid[n.name] = !0, this.numberOfInvalids() || (this.toHide = this.toHide.add(this.containers)), this.showErrors(), t(e).attr("aria-invalid", !i)), o
         },
         ...
         check: function(e) {
            ...
            if ("function" == typeof n.normalizer) {
               if (l = n.normalizer.call(e, l), "string" != typeof l) throw new TypeError("The normalizer should return a string value.");
               delete n.normalizer
            }
            for (s in n) {
               r = {
